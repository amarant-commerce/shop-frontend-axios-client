...
import type { AmarantCatalogProductCustomization } from './AmarantCatalogProductCustomization';
import type { AmarantMediaImage } from './AmarantMediaImage';

export type AmarantCatalogCustomizableProductModel = {
    customizations?: Array<AmarantCatalogProductCustomization>;
    type?: 'customizable';
    id?: (string | number);
    url?: string;
    path?: string;
